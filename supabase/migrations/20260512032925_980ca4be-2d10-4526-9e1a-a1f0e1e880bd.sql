-- 1. Add is_template flag to patients
ALTER TABLE public.patients
  ADD COLUMN IF NOT EXISTS is_template boolean NOT NULL DEFAULT false;

CREATE INDEX IF NOT EXISTS idx_patients_is_template
  ON public.patients (company_id, is_template)
  WHERE is_template = true;

-- 2. Update auto_create_claim_on_pcr_submit to propagate is_simulated + simulation_run_id
