...
Deno.serve(async (req) => {
  ...
  if (body.action === "seed" || body.action === "seed_and_submit") {
    ...
    const tripPayload: any = {
      ...
      narrative: "OATEST narrative — generated by harness.",
      chief_complaint: tplData.pcr?.chief_complaint ?? "OATEST chief complaint",
      primary_impression: tplData.pcr?.primary_impression ?? "OATEST impression",
