...
// Source of truth: src/lib/remittance-post.ts — regenerate with scripts/sync-billing-to-edge.sh
/**
...
} from "./edi-835-parser.ts";
import { getDenialTranslation } from "./denial-code-translations.ts";
import { capPatientResponsibility, type PRCapResult } from "./payer-compliance.ts";
