...
export const PAGE_HELP: Record<string, { title: string; content: HelpSection }> = {
  ...
  "/trucks": {
    ...
    content: {
      ...
      symbols: [
        ...
        { symbol: "🔄 RefreshCw icon", meaning: "Copy Week, duplicates crew assignments from source to destination week." },
  ...
  "/employees": {
    ...
    content: {
      ...
      symbols: [
        ...
        { symbol: "✉️ Mail icon", meaning: "Pending invite, employee has been invited but hasn't accepted yet." },
        { symbol: "🗑 Trash2 icon", meaning: "Delete this employee." },
        { symbol: "📋 Copy icon", meaning: "Copy invite link to clipboard." },
        { symbol: "➕ Plus icon", meaning: "Add a new employee." },
        { symbol: "🔍 Search icon", meaning: "Search employees by name or phone." },
        { symbol: "✏️ Pencil icon", meaning: "Edit employee details." },
      ],
    },
  },
  ...
  "/crew-schedule": {
    ...
    content: {
      ...
      symbols: [
        { symbol: "🔗 Link2 icon", meaning: "Share link generated for this truck/date, click to copy." },
        { symbol: "📋 Copy icon", meaning: "Copy the formatted message or link to clipboard." },
        { symbol: "🗑 Trash2 / Revoke", meaning: "Revoke the share link, immediately blocks crew access." },
        { symbol: "🚛 Truck icon", meaning: "Identifies which truck the share link is for." },
        { symbol: "👥 Users icon", meaning: "Crew members assigned to the truck." },
        { symbol: "🔄 RefreshCw icon", meaning: "Regenerate or refresh share link." },
        { symbol: "🔍 Search icon", meaning: "Search trucks or crew." },
      ],
    },
  },
  ...
  "/settings": {
    ...
    content: {
      ...
      symbols: [
        { symbol: "✅ CheckCircle2 icon", meaning: "Test Readiness Checklist, green check means step is complete." },
        { symbol: "📋 ClipboardList icon", meaning: "Staging readiness checklist section." },
      ],
    },
  },
  ...
  "/crew/:token": {
    ...
    content: {
      ...
      symbols: [
        ...
        { symbol: "🟢 Arrived (green)", meaning: "Crew has arrived at the pickup location." },
        ...
        { symbol: "📍 MapPin / tappable address", meaning: "Tap to open the address in Google Maps for navigation." },
        { symbol: "🚛 Truck icon", meaning: "Truck name and assignment header." },
        { symbol: "👥 Users icon", meaning: "Crew members listed for the shift." },
        { symbol: "⬅️ ChevronLeft", meaning: "Back button to return to run list from patient detail." },
        { symbol: "⚖️ Weight icon", meaning: "Patient weight shown in detail view." },
        { symbol: "🚪 LogOut icon", meaning: "Exit the crew run sheet." },
      ],
    },
  },
  ...
  "/billing": {
    ...
    content: {
      ...
      symbols: [
        ...
        { symbol: "⚠️ AlertTriangle", meaning: "Warning indicator, review needed or denied claim." },
        { symbol: "❌ XCircle", meaning: "Blocked or denied, critical issue." },
        { symbol: "✅ CheckCircle", meaning: "Approved or paid claim." },
        { symbol: "💰 DollarSign icon", meaning: "Charge amount or financial summary." },
        { symbol: "🔄 RefreshCw icon", meaning: "Resubmit a denied or corrected claim." },
        { symbol: "⚙️ Settings2 icon", meaning: "Charge Master configuration." },
        { symbol: "📋 ClipboardList icon", meaning: "Billing queue view." },
        { symbol: "🛡️ ShieldAlert icon", meaning: "Payer billing rules configuration." },
  ...
  "/trips": {
    ...
    content: {
      ...
      symbols: [
        ...
        { symbol: "⚠️ AlertTriangle", meaning: "Documentation incomplete, needs review." },
        { symbol: "❌ XCircle", meaning: "Critical blocker preventing billing." },
        { symbol: "✅ CheckCircle", meaning: "Documentation field complete." },
        { symbol: "📍 Location type codes (R, D, H, S, etc.)", meaning: "R = Residence, D = Dialysis, H = Hospital, S = SNF, used for HCPCS code calculation." },
        { symbol: "🔍 Search icon", meaning: "Search and filter trips." },
        { symbol: "📄 FileText icon", meaning: "Trip documentation detail." },
        { symbol: "⏱ Clock icon", meaning: "Timestamp fields (pickup, dropoff, vitals)." },
        { symbol: "🔗 ExternalLink icon", meaning: "Open linked record in another view." },
      ],
    },
  },
  ...
  "/compliance": {
    ...
    content: {
      ...
      symbols: [
        { symbol: "🛡️ ShieldCheck icon", meaning: "Compliance check passed, no issues." },
        { symbol: "⚠️ AlertTriangle", meaning: "QA flag, trip needs review." },
        { symbol: "✅ CheckCircle", meaning: "QA review approved / resolved." },
        { symbol: "🔄 RotateCcw icon", meaning: "Reset or revert a QA review." },
        { symbol: "⚙️ Settings2 icon", meaning: "Payer billing rules configuration tab." },
        { symbol: "Status badges (Pending / Approved / Rejected)", meaning: "Current QA review status." },
      ],
    },
  },
  ...
  "/facilities": {
    ...
    content: {
      ...
      symbols: [
        { symbol: "🏢 Building2 icon", meaning: "Facility record." },
        { symbol: "👥 Users icon", meaning: "Number of patients linked to this facility." },
        { symbol: "➕ Plus icon", meaning: "Add a new facility." },
        { symbol: "🔍 Search icon", meaning: "Search facilities by name." },
        { symbol: "✏️ Pencil icon", meaning: "Edit facility details." },
        { symbol: "🗑 Trash2 icon", meaning: "Delete this facility." },
      ],
    },
  },
  ...
  "/reports": {
    ...
    content: {
      ...
      symbols: [
        { symbol: "📈 TrendingUp icon", meaning: "Performance trend or positive metric." },
        { symbol: "🚛 Truck icon", meaning: "Per-truck utilization breakdown." },
        { symbol: "⚠️ AlertTriangle", meaning: "Denial count or issue indicator." },
        { symbol: "❌ XCircle", meaning: "Denied or failed claims." },
        { symbol: "✅ CheckCircle", meaning: "Completed or on-target metric." },
        { symbol: "⏱ Clock icon", meaning: "Average days to payment or time-based metric." },
        { symbol: "💰 DollarSign icon", meaning: "Revenue collected, pending, or denied amounts." },
      ],
    },
  },
  ...
  "/account": {
    ...
    content: {
      does: [
        ...
        "Notification Preferences: toggle Digest Mode to hide FYI notifications from the live bell and bundle them into a daily summary (Action Required items always come through live).",
      ...
      tips: [
        ...
        "If the bell icon feels noisy, turn on Digest Mode here — FYI items will bundle into one daily summary instead of pinging live.",
      ],
    },
  },
  ...
  "/system": {
    ...
    content: {
      ...
      symbols: [
        { symbol: "🏢 Building2 icon", meaning: "Total companies on the platform." },
  ...
  "/creator-console": {
    ...
    content: {
      ...
      symbols: [
        { symbol: "🟢 Active badge", meaning: "Company is approved and operational." },
        { symbol: "🟡 Pending badge", meaning: "Company is awaiting administrator approval." },
        ...
        { symbol: "🏢 Building2 icon", meaning: "Company record." },
        { symbol: "✅ CheckCircle2", meaning: "Approve a pending company." },
        { symbol: "🚫 Ban icon", meaning: "Suspend a company." },
        { symbol: "🔄 RefreshCw icon", meaning: "Unsuspend or restore a company." },
        { symbol: "🗑 Trash2 icon", meaning: "Delete a company (soft or permanent)." },
        { symbol: "🔑 KeyRound icon", meaning: "Force password reset for company owner." },
        { symbol: "✏️ Pencil icon", meaning: "Edit company profile." },
        { symbol: "🔍 Search icon", meaning: "Search companies by name." },
      ],
    },
  },
