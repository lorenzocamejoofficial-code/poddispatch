  ...
  "/scheduling": {
    ...
    content: {
      does: [
        ...
        "Lets you copy a full week's crew assignments forward.",
      ...
      tips: [
        ...
        "Copy Week Forward copies crew assignments only — re-run Auto-Fill on each target day for runs.",
      ],
    },
  },
  ...
  "/trucks": {
    ...
    content: {
      does: [
        ...
        "Crew assignments appear in the Scheduling Truck Builder and on Crew Run Sheets.",
      ],
      doesNot: [
