  ...
  "/crew/:token": {
    ...
    content: {
      does: [
        ...
        "'Patient Not Ready' button: if a patient is unavailable (facility delay, patient in bathroom, paperwork), tap this button on that run. Add an optional note for context — dispatch will see a live alert immediately.",
      ...
      doesNot: [
        ...
        "Patient Not Ready does not automatically reorder your run sequence — dispatch may contact you to adjust.",
      ],
      tips: [
        ...
        "Use 'Patient Not Ready' as soon as you know there's a delay — dispatch needs early warning to manage the truck sequence.",
