  ...
  "/scheduling": {
    ...
    content: {
      does: [
        ...
        "Auto-Fill: generates A and B legs from patient recurrence profiles (Dialysis/Outpatient) for the selected date — skips patients who are inactive, in hospital, on vacation, or outside their recurrence window.",
        "Lets you manually create A-legs (pickup to facility) and B-legs (return trip) for ad-hoc runs.",
        "Exception editing: click the pencil icon on any run to change pickup location, time, or notes for THAT date only — the recurring series is not affected.",
        ...
        "Trucks marked as Down (Maintenance or Out of Service) in Trucks & Crews are shown with a red DOWN badge — runs cannot be added to them, but existing runs remain visible for reassignment.",
      ],
      doesNot: [
      ...
      tips: [
        ...
        "If a truck goes down after runs are assigned, open that truck's card, use the remove (trash) button on each leg to move it to the Run Pool, then assign to another truck.",
      ],
    },
  },
