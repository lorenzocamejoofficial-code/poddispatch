...
export const PAGE_HELP_QA: Record<string, HelpQA> = {
  ...
  "/trucks": {
    ...
    questions: [
      ...
      { q: "How do I assign crew to a truck?", a: "Use the weekly calendar grid on this page. Hover any truck/day cell, click Assign, and choose up to three crew members. The system blocks the same employee from being double-booked on two trucks on the same day. A 45-minute minimum-gap warning between runs is available as an optional toggle in Admin → On-Time Settings (off by default)." },
