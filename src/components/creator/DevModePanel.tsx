...
const ROUTES = [
  { path: "/", label: "Dispatch Command", roles: ["owner", "manager", "dispatcher"] },
  { path: "/scheduling", label: "Patient Runs / Scheduling", roles: ["owner", "manager", "dispatcher"] },
  { path: "/crew-schedule", label: "Crew Schedule Delivery", roles: ["owner", "manager", "dispatcher"] },
  { path: "/patients", label: "Patients", roles: ["owner", "manager", "dispatcher"] },
  { path: "/trips", label: "Trips & Clinical", roles: ["owner", "manager", "dispatcher", "billing"] },
  { path: "/billing", label: "Billing & Claims", roles: ["owner", "manager", "billing"] },
  { path: "/compliance", label: "Compliance & QA", roles: ["owner", "manager", "billing"] },
  { path: "/facilities", label: "Facilities", roles: ["owner", "manager", "dispatcher", "billing"] },
  { path: "/reports", label: "Reports & Metrics", roles: ["owner", "manager"] },
  { path: "/employees", label: "Employees", roles: ["owner", "manager"] },
  { path: "/trucks", label: "Trucks & Crews", roles: ["owner", "manager", "dispatcher"] },
  { path: "/migration", label: "Migration & Onboarding", roles: ["owner", "manager"] },
  { path: "/simulation", label: "Company Simulation", roles: ["owner"] },
  { path: "/settings", label: "Settings", roles: ["owner", "manager"] },
...
const ROLES_MATRIX = [
  ...
  { role: "Manager", dispatch: true, scheduling: true, patients: true, trips: true, billing: true, compliance: true, facilities: true, reports: true, employees: true, trucks: true, settings: true },
