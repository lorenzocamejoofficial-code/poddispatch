...
const ROUTES = [
  { path: "/", label: "Dispatch Command", roles: ["admin", "dispatcher"] },
  { path: "/scheduling", label: "Patient Runs / Scheduling", roles: ["admin", "dispatcher"] },
  { path: "/crew-schedule", label: "Crew Schedule Delivery", roles: ["admin", "dispatcher"] },
  { path: "/patients", label: "Patients", roles: ["admin", "dispatcher"] },
  { path: "/trips", label: "Trips & Clinical", roles: ["admin", "dispatcher", "billing"] },
  { path: "/billing", label: "Billing & Claims", roles: ["admin", "billing"] },
  { path: "/compliance", label: "Compliance & QA", roles: ["admin", "billing"] },
  { path: "/facilities", label: "Facilities", roles: ["admin", "dispatcher", "billing"] },
  { path: "/reports", label: "Reports & Metrics", roles: ["admin"] },
  { path: "/employees", label: "Employees", roles: ["admin"] },
  { path: "/trucks", label: "Trucks & Crews", roles: ["admin", "dispatcher"] },
  { path: "/migration", label: "Migration & Onboarding", roles: ["admin"] },
  { path: "/simulation", label: "Company Simulation", roles: ["admin"] },
...
const ROLES_MATRIX = [
  { role: "Admin", dispatch: true, scheduling: true, patients: true, trips: true, billing: true, compliance: true, facilities: true, reports: true, employees: true, trucks: true, settings: true },
